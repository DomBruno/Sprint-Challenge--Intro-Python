...
range = ("C", "D", "E", "F", "G")
c = [human.name for human in humans if human.name[0] in range]
print(c)
# I think there's a library import that uses something like ascii_letter to allow a more pythonic :: range notation
